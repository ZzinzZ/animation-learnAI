  ...
  return (
    ...
    >
      <h2
        ...
        className="text-xl font-bold mb-4 text-theme-text section-title-text"
      >
        Your Courses
      </h2>
      <div className="space-y-4">
        {courses.map((course, index) => (
          <div
            key={course.id}
            className="bg-theme-bg rounded-xl p-4 border border-theme-border hover:shadow-lg transition-all duration-200 group cursor-pointer"
          >
